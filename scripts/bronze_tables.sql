...
-- Bronze layer stores raw data loaded directly from source systems
...
-- Drop and recreate table: stores raw product information from CRM
...
prd_start_date DATETIME, -- Date product became active
prd_end_date DATETIME    -- Date product was discontinued
);
